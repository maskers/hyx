    ...
    <div class="ui grid">
        <div class="three wide column">
            <div class="ui card">
                ...
                <div class="content">
                    <a class="header"><i class="<?php echo ($stu[sex]==2?'woman':'man'); ?> icon"></i><?php echo ($stu["sname"]); ?>[<?php echo ($stu["class"]); echo ($stu["term"]); ?>]</a>
                    <div class="meta">
                ...
                <div class="extra content">
                    <a href="<?php echo U('index',['opt'=>'mail','sid'=>$stu['sid']]);?>"><i class="mail icon"></i>发送到邮箱</a>
...
<h3 class="ui dividing header"><i class="bookmark icon"></i>当前得分</h3>
    ...
    <?php if(is_array($desum)): $i = 0; $__LIST__ = $desum;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i; if(is_array($examsum)): $i = 0; $__LIST__ = $examsum;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i; if($v['term'] == $vo['term']): ?><div class="ui tiny statistic">
